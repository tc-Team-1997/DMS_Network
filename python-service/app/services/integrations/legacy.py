"""
Legacy integration-system proxy used by app/routers/integrations.py.
Preserved here verbatim from the original app/services/integrations.py
flat module (shadowed by this package). Future adapter work goes through
base.Adapter — this entry point stays until the old router is migrated.
"""
import json
import time
