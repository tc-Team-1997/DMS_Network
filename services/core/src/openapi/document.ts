...
register([
  ...
  },
  {
    ...
    tags: ["documents"],
    security: bearer,
    summary: "Generate + persist a plain-language AI summary from the document's metadata.",
    request: { params: z.object({ id: idParam }) },
    responses: {
      200: json("Summary.", z.object({ summary: z.string() }), { summary: "This is a KYC Passport from Thimphu HQ. Key details — Full Name: A. Hassan." }),
      401: unauthorized,
      403: forbidden,
      404: notFound,
      500: internalError,
  ...
  },
  {
    ...
    tags: ["admin"],
    security: bearer,
    summary: "Read dynamic platform configuration.",
    responses: {
      200: json("Platform settings.", z.object({ settings: PlatformSettingsSchema })),
      401: unauthorized,
      403: forbidden,
      500: internalError,
    },
  },
  {
    ...
    tags: ["admin"],
    security: bearer,
    summary: "Update dynamic platform configuration.",
    description: "Invalid values are rejected with 422 { errors: string[] }.",
    request: jsonBody(PlatformSettingsSchema),
    responses: {
      200: json("Updated.", z.object({ settings: PlatformSettingsSchema })),
      401: unauthorized,
      403: forbidden,
      422: json("Invalid settings.", DedupValidationErrorSchema, { errors: ["aiConfidenceThreshold must be 0–1"] }),
      500: internalError,
    },
  },
  ...
  {
    method: "post",
    path: "/doc-types/{code}/apply-training",
    tags: ["doc-types"],
    security: bearer,
    summary: "Set a doc type's AI prompts + folder-routing template (human-approved training output).",
    request: { params: z.object({ code: codeParam }), ...jsonBody(ApplyTrainingSchema) },
    responses: {
      200: json("Applied.", z.object({ docType: DocTypeSchema })),
      400: validationErrorResponse,
      401: unauthorized,
