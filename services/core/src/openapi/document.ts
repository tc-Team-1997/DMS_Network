...
register([
  ...
  },
  {
    ...
    tags: ["dashboard"],
    security: bearer,
    summary: "Get the current user's saved dashboard layout/config (SC-01).",
    responses: {
      200: json("Layout config.", z.object({ config: z.record(z.string(), z.unknown()) })),
      401: unauthorized,
      403: forbidden,
      500: internalError,
    },
  },
  {
    ...
    tags: ["dashboard"],
    security: bearer,
    summary: "Save the current user's dashboard layout/config.",
    request: jsonBody(SetDashboardLayoutSchema),
    responses: {
      200: json("Saved.", z.object({ config: z.record(z.string(), z.unknown()) })),
      400: validationErrorResponse,
      401: unauthorized,
      403: forbidden,
      500: internalError,
